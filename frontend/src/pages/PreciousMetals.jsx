...
function PreciousMetals() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-[75vh] items-center justify-center flex-col space-y-4 bg-white text-slate-900 border border-slate-200 shadow-lg rounded-3xl p-8">
        <div className="relative flex items-center justify-center">
          <div className="w-14 h-14 border-4 border-amber-500/20 border-t-amber-500 rounded-full animate-spin"></div>
          <span className="absolute text-xl">🪙</span>
        </div>
        <p className="text-sm font-extrabold text-amber-700 tracking-wide animate-pulse font-sans">
  ...
  if (error || !ratesData) {
    return (
      <div className="max-w-md mx-auto mt-16 rounded-3xl bg-white p-8 border border-rose-200 text-center space-y-4 shadow-xl text-slate-900">
        ...
        <h3 className="text-lg font-black text-slate-900">Market Feed Unavailable</h3>
    ...
    switch (pageTheme) {
      case "silver-platinum":
        return {
          ...
          banner: "bg-gradient-to-r from-slate-50 via-slate-100 to-slate-50 border-slate-300 shadow-md text-slate-900",
          bannerAccent: "text-slate-700 shimmer-silver-text font-black",
          card: "bg-white border-slate-200 text-slate-900 shadow-md hover:border-slate-400 backdrop-blur-md",
          sectionCard: "bg-white border-slate-200 text-slate-900 shadow-md",
          textAccent: "text-slate-800",
          badge: "bg-slate-100 text-slate-800 border-slate-300",
          input: "bg-slate-50 border-slate-300 text-slate-900 focus:ring-slate-400",
          tableRowHover: "hover:bg-slate-100/60",
      ...
      case "emerald-wealth":
        return {
          bg: "bg-white text-slate-900",
          banner: "bg-gradient-to-r from-emerald-50 via-teal-100/60 to-emerald-50 border-emerald-300 shadow-md text-slate-900",
          bannerAccent: "text-emerald-700 font-extrabold",
          card: "bg-white border-emerald-200 text-slate-900 shadow-md hover:border-emerald-400 backdrop-blur-md",
          sectionCard: "bg-white border-slate-200 text-slate-900 shadow-md",
          textAccent: "text-emerald-700",
          badge: "bg-emerald-100 text-emerald-900 border-emerald-300",
          input: "bg-slate-50 border-slate-300 text-slate-900 focus:ring-emerald-500",
          tableRowHover: "hover:bg-emerald-50/50",
          textMuted: "text-slate-500",
          textPrimary: "text-slate-900"
        };
      case "ivory-light":
        return {
          bg: "bg-white text-slate-900",
          banner: "bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 border-amber-400 shadow-md text-slate-950",
          bannerAccent: "text-slate-950 font-black",
          card: "bg-white border-slate-200 text-slate-900 shadow-md hover:border-amber-400 backdrop-blur-md",
          sectionCard: "bg-white border-slate-200 text-slate-900 shadow-md",
          textAccent: "text-amber-800 font-black",
          badge: "bg-amber-100 text-amber-900 border-amber-300",
          input: "bg-slate-50 border-slate-200 text-slate-900 focus:ring-amber-500",
      ...
      default:
        return {
          bg: "bg-white text-slate-900",
          banner: "bg-gradient-to-r from-amber-50 via-amber-100/70 to-amber-50 border-amber-300 shadow-md text-slate-900",
          bannerAccent: "text-amber-800 shimmer-gold-text font-black",
          card: "bg-white border-amber-200 text-slate-900 shadow-md hover:border-amber-400 backdrop-blur-md",
          sectionCard: "bg-white border-slate-200 text-slate-900 shadow-md",
          textAccent: "text-amber-700",
          badge: "bg-amber-100 text-amber-900 border-amber-300",
          input: "bg-slate-50 border-slate-300 text-slate-900 focus:ring-amber-500",
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 transition-colors duration-500 py-6 px-4 sm:px-6 relative">
      ...
      {/* Header Banner */}
      <div className={`relative overflow-hidden rounded-3xl p-6 sm:p-8 border shadow-lg backdrop-blur-xl transition-all duration-500 ${theme.banner} space-y-6`}>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between lg:items-center gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            ...
            <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 border border-emerald-300 text-emerald-700 text-xxs font-extrabold shadow-xs font-mono">
            ...
            <button
              ...
              disabled={refreshing}
              className="px-4 py-2 rounded-2xl bg-white hover:bg-slate-50 border border-slate-300 text-xs font-extrabold text-slate-800 transition shadow-sm flex items-center gap-2 cursor-pointer disabled:opacity-50"
            >
            ...
            <a
              ...
              className="px-4 py-2 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-400 hover:from-emerald-400 hover:to-teal-300 text-slate-950 text-xs font-black transition shadow-md flex items-center gap-2 cursor-pointer border border-emerald-300/60"
            >
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-slate-200/80 text-xs font-bold">
          {/* Theme Selector */}
          <div className="flex flex-wrap items-center gap-2">
            <span className="font-extrabold flex items-center gap-1.5 shrink-0 text-amber-900">
              🎨 Accent Theme:
            </span>
            <div className="flex flex-wrap items-center gap-1 bg-white p-1 rounded-2xl border border-slate-200">
              {[
                { id: "royal-gold", label: "👑 Royal 24K Gold", activeClass: "bg-amber-500 text-slate-950 font-black shadow-xs" },
                { id: "silver-platinum", label: "⚪ Silver Platinum", activeClass: "bg-slate-300 text-slate-950 font-black shadow-xs" },
                { id: "emerald-wealth", label: "💎 Emerald Wealth", activeClass: "bg-emerald-500 text-slate-950 font-black shadow-xs" },
                { id: "ivory-light", label: "☀️ Ivory Warm", activeClass: "bg-amber-400 text-slate-950 font-black shadow-xs" },
              ].map((t) => (
                <button
                  key={t.id}
                  type="button"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* 24K Gold Card */}
        <div className="bg-white rounded-3xl p-6 border border-amber-200 hover:border-amber-400 shadow-md hover:shadow-xl space-y-4 relative overflow-hidden group hover:-translate-y-1 transition duration-300 text-slate-900 backdrop-blur-md">
          <div className="flex justify-between items-start">
            <div>
              <span className="px-2.5 py-1 rounded-full bg-amber-100 text-amber-900 border border-amber-300 text-xxs font-black uppercase tracking-wider">
                24K Gold (99.9% Fine)
              </span>
              <h3 className="text-2xl font-black text-slate-900 mt-2.5 tracking-tight font-mono">
                {formatCurrency(gold.rates["24K"].perGram)} <span className="text-xs text-slate-500 font-bold font-sans">/ g</span>
              </h3>
            </div>
            <div className="w-11 h-11 rounded-2xl bg-amber-50 border border-amber-200 text-amber-600 flex items-center justify-center text-xl font-bold shadow-inner">
              👑
            </div>
          </div>

          <div className="space-y-1.5 border-t border-slate-100 pt-3 text-xs font-semibold text-slate-700">
            <div className="flex justify-between">
              <span className="text-slate-500">10 Grams (1 Tola):</span>
              <span className="font-extrabold text-slate-900 font-mono">{formatCurrency(gold.rates["24K"].per10Gram)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500">Sovereign (8g Pavan):</span>
              <span className="font-extrabold text-slate-900 font-mono">{formatCurrency(gold.rates["24K"].perSovereign)}</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center text-xxs font-extrabold pt-1 border-t border-slate-100">
            <span className="text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200 font-mono">
              +{formatCurrency(gold.change24h.amount)} ({gold.change24h.percent}%) 24h
            </span>
            <span className="text-slate-500 font-mono">Range: ₹{gold.dayRange.low} - ₹{gold.dayRange.high}</span>
          </div>
        ...
        <div className="bg-white rounded-3xl p-6 border border-amber-200 hover:border-amber-400 shadow-md hover:shadow-xl space-y-4 relative overflow-hidden group hover:-translate-y-1 transition duration-300 text-slate-900 backdrop-blur-md">
          <div className="flex justify-between items-start">
            <div>
              <span className="px-2.5 py-1 rounded-full bg-yellow-100 text-yellow-900 border border-yellow-300 text-xxs font-black uppercase tracking-wider">
                22K Gold (Jewelry 91.6%)
              </span>
              <h3 className="text-2xl font-black text-slate-900 mt-2.5 tracking-tight font-mono">
                {formatCurrency(gold.rates["22K"].perGram)} <span className="text-xs text-slate-500 font-bold font-sans">/ g</span>
              </h3>
            </div>
            <div className="w-11 h-11 rounded-2xl bg-yellow-50 border border-yellow-200 text-yellow-600 flex items-center justify-center text-xl font-bold shadow-inner">
              ✨
            </div>
          </div>
          ...
          <div className="space-y-1.5 border-t border-slate-100 pt-3 text-xs font-semibold text-slate-700">
            <div className="flex justify-between">
              <span className="text-slate-500">10 Grams:</span>
              <span className="font-extrabold text-slate-900 font-mono">{formatCurrency(gold.rates["22K"].per10Gram)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500">Sovereign (8g Pavan):</span>
              <span className="font-extrabold text-slate-900 font-mono">{formatCurrency(gold.rates["22K"].perSovereign)}</span>
            </div>
          </div>
        ...
        {/* 18K Gold Card */}
        <div className="bg-white rounded-3xl p-6 border border-orange-200 hover:border-orange-400 shadow-md hover:shadow-xl space-y-4 relative overflow-hidden group hover:-translate-y-1 transition duration-300 text-slate-900 backdrop-blur-md">
          <div className="flex justify-between items-start">
            <div>
              <span className="px-2.5 py-1 rounded-full bg-orange-100 text-orange-900 border border-orange-300 text-xxs font-black uppercase tracking-wider">
                18K Gold (75.0% Hallmarked)
              </span>
              <h3 className="text-2xl font-black text-slate-900 mt-2.5 tracking-tight font-mono">
                {formatCurrency(gold.rates["18K"].perGram)} <span className="text-xs text-slate-500 font-bold font-sans">/ g</span>
              </h3>
            </div>
            <div className="w-11 h-11 rounded-2xl bg-orange-50 border border-orange-200 text-orange-600 flex items-center justify-center text-xl font-bold shadow-inner">
              🏆
            </div>
          </div>
          ...
          <div className="space-y-1.5 border-t border-slate-100 pt-3 text-xs font-semibold text-slate-700">
            <div className="flex justify-between">
              <span className="text-slate-500">10 Grams:</span>
              <span className="font-extrabold text-slate-900 font-mono">{formatCurrency(gold.rates["18K"].per10Gram)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500">Sovereign (8g Pavan):</span>
              <span className="font-extrabold text-slate-900 font-mono">{formatCurrency(gold.rates["18K"].perSovereign)}</span>
            </div>
          </div>
        ...
        {/* Fine Silver Card */}
        <div className="bg-white rounded-3xl p-6 border border-slate-200 hover:border-slate-400 shadow-md hover:shadow-xl space-y-4 relative overflow-hidden group hover:-translate-y-1 transition duration-300 text-slate-900 backdrop-blur-md">
          <div className="flex justify-between items-start">
            <div>
              <span className="px-2.5 py-1 rounded-full bg-slate-100 text-slate-800 border border-slate-300 text-xxs font-black uppercase tracking-wider">
                Fine Silver (99.9%)
              </span>
              <h3 className="text-2xl font-black text-slate-900 mt-2.5 tracking-tight font-mono">
                ₹{silver.rates.perGram} <span className="text-xs text-slate-500 font-bold font-sans">/ g</span>
              </h3>
            </div>
            <div className="w-11 h-11 rounded-2xl bg-slate-100 border border-slate-300 text-slate-700 flex items-center justify-center text-xl font-bold shadow-inner">
              ⚪
            </div>
          </div>
          ...
          <div className="space-y-1.5 border-t border-slate-100 pt-3 text-xs font-semibold text-slate-700">
            <div className="flex justify-between">
              <span className="text-slate-500">100 Grams:</span>
              <span className="font-extrabold text-slate-900 font-mono">{formatCurrency(silver.rates.per100Gram)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500">1 KG Bar:</span>
              <span className="font-extrabold text-indigo-600 font-mono">{formatCurrency(silver.rates.perKg)}</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center text-xxs font-extrabold pt-1 border-t border-slate-100 font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className={`lg:col-span-5 rounded-3xl p-6 sm:p-7 border shadow-md space-y-6 flex flex-col justify-between ${theme.sectionCard}`}>
          ...
          {/* Calculator Output */}
          {calcResult && (
            <div className="mt-4 p-5 rounded-2xl space-y-3 shadow-md border min-w-0 max-w-full overflow-hidden bg-gradient-to-br from-amber-500 via-amber-500 to-amber-600 text-slate-950 border-amber-400">
              <div className="flex justify-between items-center text-slate-950 text-xxs font-black uppercase tracking-wider min-w-0 gap-2">
              ...
              <div className={`text-2xl sm:text-3xl font-black text-slate-950 truncate max-w-full overflow-hidden ${numFontClass}`} title={formatCurrency(calcResult.totalAmount)}>
                {formatCurrency(calcResult.totalAmount)}
              </div>
              <div className={`flex justify-between items-center text-xxs text-slate-900 pt-2 border-t border-amber-600/30 min-w-0 gap-2 overflow-hidden ${numFontClass}`}>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full pt-2 py-2.5 rounded-xl bg-slate-950 hover:bg-slate-900 text-white text-xs font-black transition cursor-pointer flex items-center justify-center gap-1.5 shadow-md border border-slate-800 min-w-0 overflow-hidden"
              >
        ...
        <div className={`lg:col-span-7 rounded-3xl p-6 sm:p-7 border shadow-md space-y-4 flex flex-col justify-between ${theme.sectionCard}`}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center border-t border-slate-200 pt-3 text-xxs font-bold text-slate-600 font-mono">
            <div>
              <span className="text-slate-500 block font-sans">7D Low</span>
              <span className="text-slate-900 font-extrabold">
                {historyData.length > 0 ? formatCurrency(Math.min(...historyData.map(h => h.gold24kPerGram))) : "--"}
              </span>
            </div>
            <div>
              <span className="text-slate-500 block font-sans">7D High</span>
              <span className="text-slate-900 font-extrabold">
                {historyData.length > 0 ? formatCurrency(Math.max(...historyData.map(h => h.gold24kPerGram))) : "--"}
              </span>
            </div>
            <div>
              <span className="text-slate-500 block font-sans">Silver (Per KG)</span>
              <span className="text-indigo-600 font-extrabold">{formatCurrency(silver.rates.perKg)}</span>
            </div>
            <div>
              <span className="text-slate-500 block font-sans">USD/INR Base</span>
      ...
      >
        ...
        <div className="absolute -right-16 -top-16 w-80 h-80 rounded-full blur-3xl pointer-events-none bg-amber-500/10"></div>
        <div className="absolute -left-16 -bottom-16 w-80 h-80 rounded-full blur-3xl pointer-events-none bg-emerald-500/10"></div>

        {/* Section Header */}
        <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-4 border-b pb-5 relative z-10 border-slate-200">
          <div className="space-y-1">
            <div className="flex items-center gap-2.5">
              <span className="text-2xl p-1.5 rounded-xl border bg-amber-100 border-amber-200 text-amber-900">📈</span>
              <h2 className="text-xl sm:text-2xl font-black tracking-tight flex items-center gap-2 text-slate-900">
                Live Gold Asset & ETF Stock Graph
                {isLiveStream && stockTimeframe === "1D" && (
                  <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-300 text-xxs font-extrabold animate-pulse font-mono">
        ...
        <div className="flex flex-wrap items-center gap-2 relative z-10">
          <span className="text-xs font-bold mr-1 text-slate-500">Quick Select:</span>
          {[
        ...
        {stockGraphData && (
          <div className="space-y-4 relative z-10">
            <div className="p-5 rounded-2xl border flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xs bg-slate-50 border-slate-200 text-slate-900">
              <div className="flex items-baseline gap-3">
                <div>
                  <span className="text-xxs font-extrabold text-amber-700 uppercase tracking-wider block font-sans">
                    {stockGraphData.name} ({stockGraphData.category} • {stockGraphData.exchange})
                  </span>
                  <div className="text-3xl font-black tracking-tight mt-0.5 font-mono text-slate-900">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 text-xxs font-bold border-t md:border-t-0 pt-3 md:pt-0 border-slate-200">
                <div className="space-y-0.5">
                  <span className="block font-sans text-slate-500">Open</span>
                  <span className="font-extrabold font-mono text-slate-900">{formatCurrency(stockGraphData.openPrice)}</span>
                </div>
                <div className="space-y-0.5">
                  <span className="block font-sans text-slate-500">Day High</span>
                  <span className="text-emerald-700 font-extrabold font-mono">{formatCurrency(stockGraphData.dayHigh)}</span>
                </div>
                <div className="space-y-0.5">
                  <span className="block font-sans text-slate-500">Day Low</span>
                  <span className="text-rose-700 font-extrabold font-mono">{formatCurrency(stockGraphData.dayLow)}</span>
                </div>
                <div className="space-y-0.5">
                  <span className="block font-sans text-slate-500">VWAP</span>
                  <span className="text-amber-700 font-extrabold font-mono">{formatCurrency(stockGraphData.vwap)}</span>
                </div>
                <div className="space-y-0.5">
                  <span className="block font-sans text-slate-500">52W Range</span>
                  <span className="font-extrabold font-mono text-slate-900">₹{stockGraphData.fiftyTwoWeekLow} - ₹{stockGraphData.fiftyTwoWeekHigh}</span>
                </div>
                <div className="space-y-0.5">
                  <span className="block font-sans text-slate-500">Volume</span>
            ...
            <div className="px-5 py-3 rounded-xl border text-xxs font-bold space-y-1.5 bg-slate-50 border-slate-200">
              <div className="flex justify-between items-center font-mono text-slate-600">
                <span>Day Low: ₹{stockGraphData.dayLow}</span>
                <span className="text-amber-700 font-black font-sans">Price Range Position ({dayRangeProgress}%)</span>
                <span>Day High: ₹{stockGraphData.dayHigh}</span>
              </div>
              <div className="w-full h-2 rounded-full relative overflow-hidden bg-slate-200">
                <div
        ...
        <div className="h-80 w-full relative z-10 pt-2">
          {stockGraphLoading ? (
            <div className="flex h-full items-center justify-center flex-col space-y-2">
              ...
              <p className="text-xs font-bold text-slate-600">Loading live graph data for {selectedStockSymbol}...</p>
            </div>
              ...
              <AreaChart data={stockGraphData.points}>
                <defs>
                  <linearGradient id="stockGradPos" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor={stockGraphData.symbol === "SPOT_24K" ? "#d97706" : stockGraphData.isPositive ? "#059669" : "#e11d48"} stopOpacity={0.25} />
                    <stop offset="95%" stopColor={stockGraphData.symbol === "SPOT_24K" ? "#d97706" : stockGraphData.isPositive ? "#059669" : "#e11d48"} stopOpacity={0.0} />
                  </linearGradient>
                </defs>
                <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" opacity={0.7} vertical={false} />
                <XAxis dataKey="timeLabel" stroke="#475569" fontSize={10} fontWeight={700} tickLine={false} />
                <YAxis domain={["auto", "auto"]} stroke="#475569" fontSize={10} fontWeight={700} tickLine={false} axisLine={false} tickFormatter={(val) => `₹${val}`} />
                <Tooltip
                  content={({ active, payload }) => {
                    if (active && payload && payload.length) {
                      const data = payload[0].payload;
                      return (
                        <div className="p-3.5 rounded-2xl shadow-xl text-xs space-y-1.5 font-sans border bg-white border-slate-200 text-slate-900">
                          <div className="flex justify-between items-center gap-4 text-xxs font-black font-mono text-slate-500">
                            ...
                            <span className="text-amber-700">LIVE TICK</span>
                          </div>
                          <div className="text-xl font-black text-amber-700 font-mono">₹{Number(data.price).toLocaleString("en-IN")}</div>
                          <div className="grid grid-cols-2 gap-x-4 gap-y-0.5 text-xxs border-t pt-1.5 font-mono border-slate-100 text-slate-600">
                            <span>High: <strong className="text-emerald-700">₹{data.high}</strong></span>
                            <span>Low: <strong className="text-rose-700">₹{data.low}</strong></span>
                            <span className="col-span-2">Vol: <strong className="text-slate-900">{data.volume?.toLocaleString("en-IN")}</strong></span>
                          </div>
                        </div>
                      );
                    }
                ...
                {stockGraphData.openPrice && (
                  <ReferenceLine y={stockGraphData.openPrice} stroke="#64748b" strokeDasharray="3 3" label={{ value: `Open ₹${stockGraphData.openPrice}`, fill: '#64748b', fontSize: 10, position: 'insideTopLeft' }} />
                )}
                <Area
                  type={curveStyle}
                  dataKey="price"
      ...
      <div className={`rounded-3xl p-6 sm:p-8 border shadow-md space-y-6 ${theme.sectionCard}`}>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs font-semibold">
            <thead>
              <tr className={`border-b border-slate-200 uppercase text-xxs tracking-wider ${theme.textMuted}`}>
      ...
      <div className={`rounded-3xl p-6 sm:p-8 border shadow-md space-y-6 ${theme.sectionCard}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {filteredStocks.map((stock) => (
            <div
              key={stock.symbol}
              className="rounded-2xl p-5 transition-all duration-300 space-y-3 shadow-xs hover:shadow-md group flex flex-col justify-between border bg-white hover:bg-amber-50/20 border-slate-200 hover:border-amber-400 text-slate-900"
            >
              <div className="space-y-3">
                ...
                <div className="pt-2 border-t border-slate-100">
                  ...
                  <div className={`text-xxs font-semibold mt-0.5 flex justify-between ${numFontClass} ${theme.textMuted}`}>
                    ...
                    <span className={stock.isPositive ? "text-emerald-700 font-bold" : "text-rose-700 font-bold"}>
                ...
                <div className={`space-y-1 p-2.5 rounded-xl border text-xxs font-semibold ${numFontClass} bg-slate-50 border-slate-200 text-slate-700`}>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between pt-0.5 border-t border-slate-200 text-slate-500">
                    <span>Underlying:</span>
                    <span className="truncate max-w-[110px] text-slate-800 font-medium">{stock.underlying}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-3 grid grid-cols-1 gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-400 hover:from-emerald-400 hover:to-teal-300 text-slate-950 text-xs font-black transition cursor-pointer flex items-center justify-center gap-1.5 shadow-xs border border-emerald-300/40"
                >
                ...
                <button
                  ...
                  className="w-full py-2 rounded-xl bg-slate-100 hover:bg-amber-500 hover:text-slate-950 text-slate-800 text-xs font-black transition cursor-pointer flex items-center justify-center gap-1.5 border border-slate-200 group-hover:bg-amber-500 group-hover:text-slate-950 group-hover:border-amber-400"
                >
      ...
      <div className={`rounded-3xl p-6 sm:p-8 border shadow-md space-y-4 ${theme.sectionCard}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-medium leading-relaxed">
          <div className="p-4 rounded-2xl border space-y-1 bg-amber-50/80 border-amber-200 text-slate-800">
          ...
          <div className="p-4 rounded-2xl border space-y-1 bg-indigo-50/80 border-indigo-200 text-slate-800">
          ...
          <div className="p-4 rounded-2xl border space-y-1 bg-purple-50/80 border-purple-200 text-slate-800">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center pt-3 border-t border-slate-200 gap-3">
